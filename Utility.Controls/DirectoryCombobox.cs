...
namespace Utility.Controls {
    public class DirectoryComboBox : ComboBox {
        ...
        public static readonly DependencyProperty FileFilterProperty = DependencyProperty.Register("FileFilter", typeof(string), typeof(DirectoryComboBox), new PropertyMetadata(string.Empty));
