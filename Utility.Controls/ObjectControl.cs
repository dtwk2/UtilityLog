...
namespace Utility.Controls {
    ...
    /// </summary>
    public class ObjectControl : Control {
        ...
        public static readonly RoutedEvent ObjectChangedEvent = EventManager.RegisterRoutedEvent(nameof(ObjectChanged), RoutingStrategy.Bubble, typeof(RoutedPropertyChangedEventHandler<Exception>), typeof(ObjectControl));

        public static readonly DependencyProperty ControlsBorderBrushProperty = DependencyProperty.Register(nameof(ControlsBorderBrush), typeof(Brush), typeof(ObjectControl), new PropertyMetadata(default(Brush)));

        public static readonly DependencyProperty ObjectProperty = DependencyProperty.Register(nameof(Object), typeof(object), typeof(ObjectControl), new PropertyMetadata(default(Exception), OnObjectChanged));

        public static readonly DependencyProperty ShowDetailsProperty = DependencyProperty.Register(nameof(ShowDetails), typeof(bool), typeof(ObjectControl), new PropertyMetadata(true, OnShowDetailPropertyChanged));

        public static readonly DependencyProperty InnerPropertyProperty = DependencyProperty.Register("InnerProperty", typeof(string), typeof(ObjectControl), new PropertyMetadata(null));
        ...
        public ObjectControl() : this(null, null) {
        }
        ...
        /// calling ShowDialog().
        /// </summary>
        public ObjectControl(string? headerMessage = null, object? e = null) {
        ...
        private static void OnShowDetailPropertyChanged(DependencyObject d, DependencyPropertyChangedEventArgs e) {
            if (d is ObjectControl objectControl) {
