...
namespace Pcs.Hfrr.Log.View {
   ...
   public partial class ObjectView : UserControl {
      ...
      public static readonly DependencyProperty InnerPropertyProperty = DependencyProperty.Register("InnerProperty", typeof(string), typeof(ObjectView), new PropertyMetadata(null));
